...
const tutors = [
  {
    ...
    price: "$40/HR",
    strengths: ["AP Calculus", "AP Chemistry", "SAT Math", "Advanced Sciences"],
  ...
  },
  {
    ...
    price: "$35/HR",
    strengths: ["SAT Prep", "AP Calculus", "AP Biology", "Test Strategies"],
  ...
  },
  {
    ...
    price: "$30/HR",
    strengths: ["AP Chemistry", "AP Physics C", "STEM Subjects", "Patient Teaching"],
  ...
  },
  {
    ...
    price: "$25/HR",
    strengths: ["Algebra", "English Literature", "SAT Reading", "Student Support"],
  ...
  },
  {
    ...
    price: "$35/HR",
    strengths: ["AP Physics C", "AP Calculus", "Advanced Math", "Clear Explanations"],
