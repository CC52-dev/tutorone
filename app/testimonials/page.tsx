...
const testimonials = [
  {
    ...
    improvement: "C+ TO A",
    quote:
      "DR. CHEN TRANSFORMED MY UNDERSTANDING OF CALCULUS. HER NO-NONSENSE APPROACH AND RELENTLESS FOCUS ON FUNDAMENTALS TOOK ME FROM STRUGGLING TO EXCELLING. NOW I'M HEADING TO MIT FOR ENGINEERING.",
    beforeAfter: {
      before: "FAILING CALCULUS MIDTERM",
      after: "98% ON FINAL EXAM",
    },
  },
  {
    id: 2,
    ...
    grade: "11TH GRADE",
    subject: "CHEMISTRY",
    tutor: "PROF. MARCUS WRIGHT",
    rating: 5,
    improvement: "D TO A-",
    quote:
      "PROF. WRIGHT MADE CHEMISTRY CLICK FOR ME. HIS LAB-FOCUSED APPROACH AND REAL-WORLD APPLICATIONS TURNED MY WORST SUBJECT INTO MY FAVORITE. ORGANIC CHEMISTRY IS NO LONGER A NIGHTMARE.",
    beforeAfter: {
      before: "CONFUSED BY MOLECULAR STRUCTURES",
      after: "ACING ORGANIC CHEMISTRY",
    },
  },
  {
    id: 3,
    ...
    grade: "SENIOR",
    subject: "SAT PREP",
    tutor: "MS. ELENA RODRIGUEZ",
    rating: 5,
    improvement: "1200 TO 1520",
    quote:
      "MS. RODRIGUEZ'S SAT STRATEGIES ARE BRUTAL BUT EFFECTIVE. SHE PUSHED ME BEYOND MY COMFORT ZONE AND TAUGHT ME TO THINK LIKE THE TEST MAKERS. MY SCORE JUMPED 320 POINTS IN 3 MONTHS.",
    beforeAfter: {
      before: "1200 SAT SCORE",
      after: "1520 SAT SCORE",
    },
  },
  {
    id: 4,
    ...
    improvement: "F TO B+",
    quote:
      "I WAS READY TO DROP PHYSICS UNTIL I FOUND DR. CHEN. HER SYSTEMATIC APPROACH TO PROBLEM-SOLVING AND VISUAL EXPLANATIONS SAVED MY ACADEMIC CAREER. NOW I'M CONSIDERING PHYSICS MAJOR.",
    beforeAfter: {
      before: "FAILING PHYSICS CLASS",
      after: "TOP 10% OF CLASS",
    },
  },
  {
    id: 5,
    ...
    tutor: "MS. ELENA RODRIGUEZ",
    rating: 5,
    improvement: "BEGINNER TO FLUENT",
    quote:
      "MS. RODRIGUEZ'S IMMERSION METHOD IS INTENSE BUT INCREDIBLE. SHE REFUSED TO LET ME SPEAK ENGLISH DURING SESSIONS. NOW I'M BILINGUAL AND CONFIDENT FOR COLLEGE SPANISH PLACEMENT.",
    beforeAfter: {
      before: "ZERO SPANISH KNOWLEDGE",
      after: "CONVERSATIONAL FLUENCY",
    },
  },
  {
    id: 6,
    ...
    improvement: "C TO A+",
    quote:
      "PROF. WRIGHT'S RESEARCH BACKGROUND BRINGS BIOLOGY TO LIFE. HIS CONNECTIONS TO REAL MEDICAL APPLICATIONS MOTIVATED ME TO PURSUE PRE-MED. HIS MENTORSHIP EXTENDS BEYOND ACADEMICS.",
    beforeAfter: {
      before: "MEMORIZING WITHOUT UNDERSTANDING",
      after: "THINKING LIKE A SCIENTIST",
    },
  },
]
